...
N_GPU=1
BATCH=64
DATA=/work/home/acd85yw2dx/ImageNet-S/ImageNetS50
IMAGENETS=/work/home/acd85yw2dx/ImageNet-S/ImageNetS50
...
# HIP_VISIBLE_DEVICES=${CUDA} python inference_pixel_attention.py -a ${ARCH} \
# --pretrained ${DUMP_PATH_FINETUNE}/checkpoint.pth.tar \
# --data_path ${IMAGENETS} \
# --dump_path ${DUMP_PATH_FINETUNE} \
# -c ${NUM_CLASSES} \
...
# HIP_VISIBLE_DEVICES=${CUDA} python evaluator.py \
...
HIP_VISIBLE_DEVICES=${CUDA} python inference.py -a ${ARCH} \
